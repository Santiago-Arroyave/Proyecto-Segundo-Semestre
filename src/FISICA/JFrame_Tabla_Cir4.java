...
public class JFrame_Tabla_Cir4 extends JFrame{
...
DecimalFormat df = new DecimalFormat();
	...
	OPCION_MIXTO o;
	JFrame_Cir4_R r;
	Calculo_JFrame_Cir4 s;
	
	JButton volver;
	JTextField V1,V2,V3,V4,V5,V6,V7,V8,V9,I1,I2,I3,I4,I5,I6,I7,I8,I9,
	P1,P2,P3,P4,P5,P6,P7,P8,P9;
	JLabel R1,R2,R3,R4,R5,R6,R7,R8,R9,resis,vol,corrien,poten;
	
	public JFrame_Tabla_Cir4 (FISICA_2 f,OPCION_MIXTO o,JFrame_Cir4_R r,Calculo_JFrame_Cir4 s) {
		this.f = f;
		this.o = o;
		this.r = r;
		this.s = s;
		...
		volver.setBounds(340,320,80,30);
		...
		V4.setText(String.valueOf(df.format(s.VE6)));
		V5.setText(String.valueOf(df.format(s.VE4)));
		V6.setText(String.valueOf(df.format(s.VE4)));
		...
		I2.setText(String.valueOf(df.format(s.IE5)));
		I3.setText(String.valueOf(df.format(s.IE1)));
		...
		I8.setText(String.valueOf(df.format(s.IE1)));
		I9.setText(String.valueOf(df.format(s.IE3)));
		...
		JPanel_Tabla_Cir4 m = new JPanel_Tabla_Cir4();
		add(m);
