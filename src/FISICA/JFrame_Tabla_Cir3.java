...
public class JFrame_Tabla_Cir3 extends JFrame {
...
DecimalFormat df = new DecimalFormat();
	...
	OPCION_MIXTO o;
	JFrame_Cir3 r;
	Calculo_JFrame_Cir3 s;
	
	JButton volver;
	JTextField V1,V2,V3,V4,V5,V6,V7,V8,V9,V10,I1,I2,I3,I4,I5,I6,I7,I8,I9,I10,
	P1,P2,P3,P4,P5,P6,P7,P8,P9,P10;
	JLabel R1,R2,R3,R4,R5,R6,R7,R8,R9,R10,resis,vol,corrien,poten;
	
	public JFrame_Tabla_Cir3 (FISICA_2 f,OPCION_MIXTO o,JFrame_Cir3 r,Calculo_JFrame_Cir3 s) {
		this.f = f;
		this.o = o;
		this.r = r;
		this.s = s;
		...
		volver.setBounds(340,360,80,30);
		...
		V2.setText(String.valueOf(df.format(s.VR2)));
		V3.setText(String.valueOf(df.format(s.VR3)));
		V4.setText(String.valueOf(df.format(s.VR4)));
		V5.setText(String.valueOf(df.format(s.VR5)));
		V6.setText(String.valueOf(df.format(s.VE2)));
		V7.setText(String.valueOf(df.format(s.VE2)));
		V8.setText(String.valueOf(df.format(s.VR8)));
		V9.setText(String.valueOf(df.format(s.VE1)));
		V10.setText(String.valueOf(df.format(s.VE1)));
		
		I1.setText(String.valueOf(df.format(s.IT)));
		I2.setText(String.valueOf(df.format(s.IT)));
		I3.setText(String.valueOf(df.format(s.IE5)));
		I4.setText(String.valueOf(df.format(s.IE4)));
		I5.setText(String.valueOf(df.format(s.IE4)));
		I6.setText(String.valueOf(df.format(s.IR6)));
		I7.setText(String.valueOf(df.format(s.IR7)));
		I8.setText(String.valueOf(df.format(s.IE5)));
		I9.setText(String.valueOf(df.format(s.IR9)));
		I10.setText(String.valueOf(df.format(s.IR10)));
		...
		JPanel_Tabla_Cir3 m = new JPanel_Tabla_Cir3();
		add(m);
